...
salesdata['Product Category']= label_encoder.fit_transform(salesdata['Product Category'])

X = salesdata[['Product Category', 'Age', 'Quantity', 'Price per Unit']]
y = salesdata['Gender']
df_features = pd.DataFrame(X, columns=['Product Category', 'Age', 'Quantity', 'Price per Unit'])  
df_features['Gender'] = y 
